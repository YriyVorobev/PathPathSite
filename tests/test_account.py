...
class TestAccount(BaseTest):
    ...
    def test_my_info_fill_out(self):
        ...
        self.my_info_page.personal_details.licence_expire_date("12-24-2025")
        self.my_info_page.personal_details.date_of_birth("10-12-1997")
        self.my_info_page.personal_details.gender_male()
        self.my_info_page.personal_details.save_changed()
        self.my_info_page.personal_details.test_field("323434")
